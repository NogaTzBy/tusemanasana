      ...
      `}} />
            ...
            <div className="flex items-center gap-3 mb-3 relative z-10">
                <div className="relative w-8 h-8 shrink-0">
                    <Image fill sizes="32px" className="object-contain" src="https://cdn.shopify.com/s/files/1/0593/0814/6858/files/iconos_dev_new_card_Mesa_de_trabajo_1_copia_2.svg?v=1735484042" alt="MercadoLíder Platinum" />
                </div>
                <div>
            ...
            <div className="flex justify-between gap-3 relative z-10">
                ...
                <div className="flex-1 flex flex-col items-center gap-0.5 text-center">
                    <div className="relative w-5 h-5 mb-1">
                        <Image fill sizes="20px" className="object-contain" src="https://cdn.shopify.com/s/files/1/0593/0814/6858/files/iconos_dev_new_card_Mesa_de_trabajo_1_copia.svg?v=1735483382" alt="Buena atención" />
                    </div>
                    <div className="text-[11px] text-[#666666]">Buena atención</div>
                </div>
                <div className="flex-1 flex flex-col items-center gap-0.5 text-center">
                    <div className="relative w-5 h-5 mb-1">
                        <Image fill sizes="20px" className="object-contain" src="https://cdn.shopify.com/s/files/1/0593/0814/6858/files/iconos_dev_new_card_Mesa_de_trabajo_1.svg?v=1735483382" alt="Entrega a tiempo" />
                    </div>
